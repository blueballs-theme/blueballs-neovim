...
-- telescope {{{
high_link("TelescopeNormal", "NormalPopover")
high_link("TelescopePreviewNormal", "TelescopeNormal")
high_link("TelescopeBorder", "FloatBorder")
-- }}}
...
vim.g.terminal_color_8 = comment
vim.g.terminal_color_9 = red1
vim.g.terminal_color_10 = green1
vim.g.terminal_color_11 = yellow1
vim.g.terminal_color_12 = blue1
vim.g.terminal_color_13 = purple1
vim.g.terminal_color_14 = cyan1
vim.g.terminal_color_15 = accent
-- }}}
